concrete StructuralSwe of Structural = CatSwe ** 
  ...
  every_Det = {
    s = \\_,_,_ => "varje" ; 
    sp = \\_,_ => genderForms ["var och en"] ["vart och ett"] ; ----
    n = Sg ; 
    det = DIndef
    } ;
  everything_NP = regNP "allting" "alltings" Neutr Sg ;
  everywhere_Adv = mkAdv "överallt" ;
  few_Det  = {s,sp = \\_,_,_ => "få" ; n = Pl ; det = DDef Indef} ;
---  first_Ord = {s = "första" ; isDet = True} ;
  for_Prep = ss "för" ;
  from_Prep = ss "från" ;
  he_Pron = mkPron "han"  "honom"  "hans" "hans" "hans"  Utr Sg P3 ;
  here_Adv = mkAdv "här" ;
  ...
  i_Pron = mkPron "jag"  "mig"  "min" "mitt" "mina"  Utr Sg P1 ;
  in_Prep = ss "i" ;
  it_Pron = regPron "det" "dess" Neutr Sg ;
  less_CAdv = X.mkCAdv "mindre" "än" ;
  many_Det = {s,sp = \\_,_,_ => "många" ; n = Pl ; det = DDef Indef} ;
  more_CAdv = X.mkCAdv "mer" "än" ;
  most_Predet = {s = detForms ["den mesta"] ["det mesta"] ["de flesta"] ; p = [] ; a = PNoAg} ;
  much_Det = {s,sp = \\_,_,_ => "mycket" ; n = Pl ; det = DDef Indef} ;
  must_VV = 
...
---  one_Quant = {s = \\_,_ => genderForms ["en"] ["ett"] ; n = Sg ; det = DIndef} ;
  ...
  possess_Prep = ss "av" ;
  quite_Adv = ss "ganska" ;
  she_Pron = mkPron "hon" "henne" "hennes" "hennes" "hennes"  Utr Sg P3 ;
  so_AdA = ss "så" ;
  someSg_Det = {s,sp = \\_,_ => genderForms "någon" "något" ; n = Sg ; det = DIndef} ;
  somePl_Det = {s,sp = \\_,_,_ => "några" ; n = Pl ; det = DIndef} ;
  somebody_NP = regNP "någon" "någons" Utr Sg ;
  something_NP = regNP "något" "någots" Neutr Sg ;
  somewhere_Adv = mkAdv "någonstans" ;
  that_Quant = 
    {s,sp = \\_ => table {
  ...
  they_Pron = mkPron "de" "dem" "deras" "deras" "deras" Utr Pl P3 ;
  this_Quant = 
    {s,sp = \\_ => table {
  ...
  want_VV = 
    ...
    {c2 = mkComplement [] ; lock_VV = <>} ;
  we_Pron = mkPron "vi"  "oss"  "vår" "vårt" "våra"  Utr Pl P1 ;
  ...
  with_Prep = ss "med" ;
  yes_Utt = ss ["ja"] ;
  youSg_Pron = mkPron "du" "dig" "din" "ditt" "dina" Utr Sg P2 ;
  youPl_Pron = mkPron "ni" "er" "er" "ert" "era"  Utr Pl P2 ;
  youPol_Pron = mkPron "ni" "er" "er" "ert" "era"  Utr Sg P2 ; --- wrong in refl

-- Auxiliaries that are used repeatedly.

  oper
    vem = mkPron "vem" "vem" "vems" "vems" "vems" Utr Sg P3 ;
